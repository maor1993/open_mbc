...
pub fn build_ui(
    ...
    let resp = ui.horizontal(|ui| {
        ...
        let sig0 = gain_to_db_fast(peak_meter_val[0].load(std::sync::atomic::Ordering::Relaxed));
        let sig1 = gain_to_db_fast(peak_meter_val[1].load(std::sync::atomic::Ordering::Relaxed));
